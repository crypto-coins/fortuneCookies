...
var nicks = [
    ...
    { public_key: "03bb88ccc444534da7b5b64b4f7b15e1eccb18e102db0e400d4b9cfe93763aa26d", nick_name: "to-me"},
...
function AddNickChannel (channel) {
    var nick = R.find(R.propEq('partner_public_key', channel.public_key))(nicks);
    if (nick==undefined) {
        peer.nick = "?";
    } else {
        peer.nick = nick.nick_name;
